...
public final class RobotConstants {
    ...
    public static final class ReefAimConstants {
        ...
        public static final TunableNumber ROBOT_TO_PIPE_L4_METERS = new TunableNumber("AIM/ROBOT_TO_PIPE_L4_METERS", 0.52);
        public static final TunableNumber ROBOT_TO_PIPE_METERS = new TunableNumber("AIM/ROBOT_TO_PIPE_METERS", 0.53);
        public static final TunableNumber X_TOLERANCE_METERS = new TunableNumber("AIM/X_TOLERANCE_METERS", 0.03);
        public static final TunableNumber Y_TOLERANCE_METERS = new TunableNumber("AIM/Y_TOLERANCE_METERS", 0.03);
